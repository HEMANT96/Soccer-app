...
const CentresList = () =>
  import(/* webpackChunkName: "tables" */ 'src/pages/Centres/List.vue');
const CentresEdit = () =>
  import(/* webpackChunkName: "tables" */ 'src/pages/Centres/Edit.vue');
  ...
  children: [
    {
      path: 'list',
      name: 'Centres List',
      components: { default: CentresList }
    },
    {
      path: 'edit',
      name: 'Centre Edit',
      components: { default: CentresEdit }
    }
  ]
};

const UsersList = () =>
  import(/* webpackChunkName: "tables" */ 'src/pages/Users/List.vue');
...
const BookingsList = () =>
  import(/* webpackChunkName: "tables" */ 'src/pages/Bookings/List.vue');
  ...
  children: [
    {
      path: 'list',
      name: 'Bookings List',
      components: { default: BookingsList }
    }
  ]
};
